...
const Home = () => {
  return (
    <>
        ...
        <div className="container">
          <div className="flex flex-col lg:flex-row gap-[90px] items-center justify-between">
            ...
            <div>
              ...
              {/*========== hero counters ======== */}
              <div className="mt-[30px] lg:mt-[70px] flex flex-col lg:flex-row items-start gap-[10px]">
                <div className="flex flex-col items-start">
                  <h2 className="text-[36px] leading-[56px] lg:text-[44px] lg:leading-[54px] font-[700] text-headingColor">
                    30+
                  </h2>
                  <span className="w-[100px] h-2 bg-yellowColor rounded-full block"></span>
                  <p className="text-[16px] text-textColor font-[500]">
                    Years of Experience
                  </p>
                </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 lg:gap-[30px] mt-[30px] lg:mt-[55px]">
            ...
            <div className="py-[30px] px-5">
              ...
              <div className="mt-[30px]">
                ...
                <Link
                  to="/doctors"
                  className="w-[44px] h-[44px] rounded-full border border-[#181A1E] mt-[30px] mx-auto flex items-center justify-center group hover:bg-primaryColor hover:border-none"
                >
              ...
              <div className="mt-[30px]">
                ...
                <Link
                  to="/doctors"
                  className="w-[44px] h-[44px] rounded-full border border-[#181A1E] mt-[30px] 
      ...
      <div className="text-[10px] leading-[10px] lg:text-[14px] lg:leading-5 text-headingColor font-[600]">
        Tue, 24
      </div>
