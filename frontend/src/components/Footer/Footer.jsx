...
import { RiLinkedinFill } from "react-icons/ri"; // Korrigjohet importimi

const socialLinks = [
  {
    path: "https://www.youtube.com/c/CodingWithMuhib",
    icon: <AiFillYoutube className="group-hover:text-white w-4 h-5" />, // Korrigjohet "grooup" në "group"
  },
  {
